...
class ActiveLearningScreeningSimulationTask(TaskInterface, PreEmbedMixin):
    ...
    def _run_single_iteration(
        ...
        print(
            f"[ITER] building iteration config: use_disorder={self.al_campaign_config.use_disorder_in_acquisition}, "
            f"method={self.al_campaign_config.disorder_aggregation_method}, "
            f"gamma={self.al_campaign_config.disorder_weight}"
        )
        al_iteration_config = ActiveLearningScreeningIterationConfig(
            ...
            use_disorder_in_acquisition=self.al_campaign_config.use_disorder_in_acquisition,
            disorder_weight=self.al_campaign_config.disorder_weight,
            disorder_aggregation_method=self.al_campaign_config.disorder_aggregation_method,
        )
