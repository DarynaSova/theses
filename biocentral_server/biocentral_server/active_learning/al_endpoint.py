...
async def active_learning_screening_simulation(
    ...
    # Launch AL process
    print(
        f"[ENDPOINT] screening_simulation received campaign config: "
        f"use_disorder={request_data.campaign_config.use_disorder_in_acquisition}, "
        f"method={request_data.campaign_config.disorder_aggregation_method}, "
        f"gamma={request_data.campaign_config.disorder_weight}"
    )
    ...
    print(
        f"[ENDPOINT] created task with campaign config: "
        f"use_disorder={al_process.al_campaign_config.use_disorder_in_acquisition}, "
        f"method={al_process.al_campaign_config.disorder_aggregation_method}, "
        f"gamma={al_process.al_campaign_config.disorder_weight}"
    )
    task_manager.add_task(task=al_process, task_id=task_id, user_id=user_id)
