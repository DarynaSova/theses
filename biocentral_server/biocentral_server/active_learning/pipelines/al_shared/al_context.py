...
class ALContext(PipelineContext):
    ...
    def __init__(
        ...
        use_disorder_in_acquisition: bool = False,
        disorder_weight: float = 0.0,
        disorder_aggregation_method: str = "mean",
    ):
        ...
        # Disorder-in-acquisition config
        self.use_disorder_in_acquisition = use_disorder_in_acquisition
        self.disorder_weight = disorder_weight
        self.disorder_aggregation_method = disorder_aggregation_method
