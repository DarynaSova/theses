...
def al_screening_pipeline(
    ...
    pipeline_context = ScreeningPipelineContext(
        ...
        use_disorder_in_acquisition=al_campaign_config.use_disorder_in_acquisition,
        disorder_weight=al_campaign_config.disorder_weight,
        disorder_aggregation_method=al_campaign_config.disorder_aggregation_method,
    )
