...
DISORDER_CONFIG = {
    "enabled": True,
    "aggregation_method": "frac_above_5",
    "weight": 2.0,
}
...
def _run_experiment(experiment_params: ExperimentParametersV1):
    ...
    if use_save and save_dir.exists():
        ...
        al_simulator = get_simulator(
            ...
            use_disorder=DISORDER_CONFIG["enabled"],
            disorder_method=DISORDER_CONFIG["aggregation_method"],
            disorder_weight=DISORDER_CONFIG["weight"],
        )
...
def main():
    run_name = "with_disorder_frac_above_5_weight_2.0"
