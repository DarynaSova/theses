"""
Utility to load per-residue disorder scores from FASTA format and compute aggregate statistics.

Expected format for disorder FASTA files:
  >seq_id TARGET=label
  value1, value2, value3, ...
  >seq_id2 TARGET=label2
  value1, value2, value3, ...

The values are per-residue disorder scores (floats).
"""
